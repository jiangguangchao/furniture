...
INSERT INTO `purchase_order` VALUES (1,'张三','2024-09-29','0','152222212',NULL,'[{\"name\": \"床\", \"quantity\": 1, \"unitPrice\": 1000, \"totalPrice\": 1000}]',1000.00,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=154 DEFAULT CHARSET=utf8mb3 COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `upload_file` (
  `id` varchar(32) NOT NULL,
  `association_id` bigint NOT NULL COMMENT '关联id',
  `association_type` varchar(8) NOT NULL COMMENT '关联类型',
...
-- Dump completed on 2024-09-30 17:00:53
